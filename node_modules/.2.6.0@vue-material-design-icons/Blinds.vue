<template>
  <span :aria-hidden="decorative"
        :aria-label="title"
        class="material-design-icon blinds-icon"
        role="img">
    <svg :fill="fillColor"
