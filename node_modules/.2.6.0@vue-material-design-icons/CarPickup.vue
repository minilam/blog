<template>
  <span :aria-hidden="decorative"
        :aria-label="title"
        class="material-design-icon car-pickup-icon"
        role="img">
    <svg :fill="fillColor"
