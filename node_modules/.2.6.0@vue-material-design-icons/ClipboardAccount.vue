<template>
  <span :aria-hidden="decorative"
        :aria-label="title"
        class="material-design-icon clipboard-account-icon"
        role="img">
    <svg :fill="fillColor"
...
<script>
export default {
  name: "ClipboardAccountIcon",
  props: {
    title: {
      type: String,
      default: "Clipboard Account icon"
    },
    decorative: {
      type: Boolean,
      default: false
