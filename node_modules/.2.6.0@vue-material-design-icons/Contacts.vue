<template>
  <span :aria-hidden="decorative"
        :aria-label="title"
        class="material-design-icon contacts-icon"
        role="img">
    <svg :fill="fillColor"
