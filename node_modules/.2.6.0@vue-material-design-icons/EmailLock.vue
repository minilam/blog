<template>
  <span :aria-hidden="decorative"
        :aria-label="title"
        class="material-design-icon email-lock-icon"
        role="img">
    <svg :fill="fillColor"
