<template>
  <span :aria-hidden="decorative"
        :aria-label="title"
        class="material-design-icon google-physical-web-icon"
        role="img">
    <svg :fill="fillColor"
...
<script>
export default {
  name: "GooglePhysicalWebIcon",
  props: {
    title: {
      type: String,
      default: "Google Physical Web icon"
    },
    decorative: {
      type: Boolean,
      default: false
