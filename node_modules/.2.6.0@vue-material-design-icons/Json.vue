<template>
  <span :aria-hidden="decorative"
        :aria-label="title"
        class="material-design-icon json-icon"
        role="img">
    <svg :fill="fillColor"
