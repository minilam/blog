<template>
  <span :aria-hidden="decorative"
        :aria-label="title"
        class="material-design-icon lava-lamp-icon"
        role="img">
    <svg :fill="fillColor"
