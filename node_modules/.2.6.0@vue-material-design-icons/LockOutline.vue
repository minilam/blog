<template>
  <span :aria-hidden="decorative"
        :aria-label="title"
        class="material-design-icon lock-outline-icon"
        role="img">
    <svg :fill="fillColor"
