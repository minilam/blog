<template>
  <span :aria-hidden="decorative"
        :aria-label="title"
        class="material-design-icon lock-pattern-icon"
        role="img">
    <svg :fill="fillColor"
...
<script>
export default {
  name: "LockPatternIcon",
  props: {
    title: {
      type: String,
      default: "Lock Pattern icon"
    },
    decorative: {
      type: Boolean,
      default: false
