<template>
  <span :aria-hidden="decorative"
        :aria-label="title"
        class="material-design-icon message-settings-variant-icon"
        role="img">
    <svg :fill="fillColor"
...
<script>
export default {
  name: "MessageSettingsVariantIcon",
  props: {
    title: {
      type: String,
      default: "Message Settings Variant icon"
    },
    decorative: {
      type: Boolean,
      default: false
