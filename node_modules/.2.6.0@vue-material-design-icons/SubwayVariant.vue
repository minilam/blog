<template>
  <span :aria-hidden="decorative"
        :aria-label="title"
        class="material-design-icon subway-variant-icon"
        role="img">
    <svg :fill="fillColor"
...
<script>
export default {
  name: "SubwayVariantIcon",
  props: {
    title: {
      type: String,
      default: "Subway Variant icon"
    },
    decorative: {
      type: Boolean,
      default: false
