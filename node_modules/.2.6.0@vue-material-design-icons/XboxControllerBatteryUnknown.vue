<template>
  <span :aria-hidden="decorative"
        :aria-label="title"
        class="material-design-icon xbox-controller-battery-unknown-icon"
        role="img">
    <svg :fill="fillColor"
...
<script>
export default {
  name: "XboxControllerBatteryUnknownIcon",
  props: {
    title: {
      type: String,
      default: "Xbox Controller Battery Unknown icon"
    },
    decorative: {
      type: Boolean,
      default: false
